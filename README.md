...
`MAIL_DEFAULT_SENDER`, `MAIL_USE_TLS`, `MAIL_USE_SSL`, `FCM_API_KEY` (your Firebase Cloud Messaging API key). Then add `SQLALCHEMY_DATABASE_URI = os.getenv('DATABASE_URL')` (don't forget to import `os`)
